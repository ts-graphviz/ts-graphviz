import { GraphBaseModel } from '../../../../common/models.js';
import { ClusterStatementASTNode } from '../../../types.js';
import { ConvertContext } from '../../types.js';
import { convertAttribute } from './convert-attribute.js';
import { convertComment } from './convert-comment.js';

export function convertClusterChildren(context: ConvertContext, model: GraphBaseModel) {
  return Array.from(
