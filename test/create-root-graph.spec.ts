...
describe('Root Graph Creation Functions', () => {
  describe('digraph()', () => {
    it('returns a directed non-strict Digraph when called without parameters', () => {
      const g = digraph();
    ...
    describe('parameterized creation scenarios', () => {
      test.each([
    ...
    it('builds graph using callback-style builder pattern', () => {
      const G = digraph('G', (g) => {
        const a = g.node('aa');
        const b = g.node('bb');
        const c = g.node('cc');
    ...
    it('builds graph with attributes object in callback-style builder', () => {
      const G = digraph('G', (g) => {
        const a = g.node('aa');
        const b = g.node('bb');
        const c = g.node('cc');
    ...
    it('includes comments on graph, nodes, edges, and subgraphs', () => {
      const G = digraph('G', (g) => {
  ...
  describe('graph()', () => {
    it('returns an undirected non-strict Graph when called without parameters', () => {
      const g = graph();
    ...
    it('escapes special characters in names and labels', () => {
      const G = graph('G\n"', (g) => {
        const a = g.node('a\na');
  ...
  describe('strict mode variants', () => {
    it('strict.digraph() returns a strict directed Digraph instance', () => {
    ...
    it('strict.graph() returns a strict undirected Graph instance', () => {
