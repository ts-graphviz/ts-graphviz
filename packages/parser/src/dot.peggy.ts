/* eslint-disable prefer-template,no-else-return,lines-between-class-members,object-shorthand,@typescript-eslint/no-unused-vars,no-lonely-if,@typescript-eslint/no-empty-interface,no-use-before-define,no-plusplus,one-var,@typescript-eslint/no-explicit-any,no-underscore-dangle,prefer-const,no-proto,no-restricted-syntax,func-names,camelcase,no-param-reassign,no-case-declarations,default-case,consistent-return,no-control-regex */
...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c32 = function (list: any): any {
    return list;
  };
  const peg$c33 = function (id: any, v: any): any {
    return v;
  };
  ...
  const peg$c39 = function (operator: any): any {
  ...
  const peg$c70 = function (value: any): any {
    return { value, quoted: true };
  };
  const peg$c71 = function (v: any): any {
    return {
      type: 'literal',
      ...v,
      location: location(),
  ...
  const peg$c72 = function (value: any): any {
    return {
      type: 'literal',
      value,
      quoted: false,
  ...
  const peg$c77 = peg$anyExpectation();
  ...
  const peg$c82 = function (v: any): any {
    return v.join('');
  };
  const peg$c83 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c86 = peg$otherExpectation('UNICODE_STRING');
  const peg$c87 = function (first: any, rest: any): any {
  ...
  const peg$c91 = '_';
  const peg$c92 = peg$literalExpectation('_', false);
  const peg$c93 = peg$otherExpectation('NUMBER');
  const peg$c94 = '-';
  ...
  const peg$c106 = function (v: any): any {
    return '<' + v.join('') + '>';
  };
