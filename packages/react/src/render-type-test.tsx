...
import { type RenderResult, render } from './render.js';
...
async function _testDigraphRendering() {
...
async function _testNodeRenderingWithContainer() {
...
async function _testSubgraphRendering() {
...
async function _testGenericTypeInference() {
...
async function _testRenderResultStructure() {
...
async function _testComplexNestedRendering() {
...
async function _testContainerTypeConstraints() {
  ...
  const result1 = await render(<Node id="test" />, {
    container: validContainer,
  });
  const result2 = await render(<Node id="test" />, {
    container: subgraphContainer,
  });
  const result3 = await render(<Node id="test" />, {
