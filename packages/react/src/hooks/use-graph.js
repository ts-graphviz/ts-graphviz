...
function useGraph(_a) {
    ...
    var memoGraph = (0, react_1.useMemo)(function () {
        var g = new ts_graphviz_1.Graph(id);
        context.root = g;
        g.comment = comment;
        g.apply(attributes);
    ...
    (0, use_comment_1.useHasComment)(memoGraph, comment);
    (0, use_cluster_attributes_1.useClusterAttributes)(memoGraph, attributes, { edge: edge, node: node, graph: graph });
